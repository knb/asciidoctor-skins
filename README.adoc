...
* **Skin preview demo:** https://knb.github.io/asciidoctor-skins/[knb.github.io/asciidoctor-skins]
* **Skin Maker editor:** https://knb.github.io/asciidoctor-skins/skin-maker/editor/index.html[Open the visual editor]
...
**Open on GitHub Pages:** https://knb.github.io/asciidoctor-skins/skin-maker/editor/index.html[Skin Maker editor]
...
You can preview all of the stylesheets in the https://darshandsoni.com/asciidoctor-skins[online demo] (upstream) or on https://knb.github.io/asciidoctor-skins/[GitHub Pages] (this fork).
...
Generated CSS is written to `css/`. Use the link:https://knb.github.io/asciidoctor-skins/skin-maker/editor/index.html[visual editor] for interactive tuning, or edit YAML directly.
