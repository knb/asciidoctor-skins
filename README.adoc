...
Open link:skin-maker/editor/index.html[skin-maker/editor/index.html] in a browser after preparing assets:

[source,bash]
----
bundle exec rake editor:prepare
# then open skin-maker/editor/index.html
----

The editor provides live preview on `index2.html`, layout switching (`material`, `plain`, `bootswatch`, `tufte`), and YAML export.
